...
const MESSAGES: Messages = {
  ...
  "app.lock.error.empty": { "zh-CN": "请输入 Master Key 以解锁应用", "en-US": "Enter the Master Key to unlock the app" },
  "app.lock.error.invalid": { "zh-CN": "Master Key 不正确，请重试", "en-US": "That Master Key did not work. Try again." },
  "app.lock.error.verifyFail": { "zh-CN": "无法验证 Master Key，请稍后重试", "en-US": "Could not verify the Master Key. Try again." },
  ...
  "app.lock.reset.confirm": { "zh-CN": "重置并清空数据", "en-US": "Reset and erase data" },
  ...
  "sshTrust.algorithm": { "zh-CN": "主机密钥算法", "en-US": "Host key algorithm" },
  "sshTrust.target": { "zh-CN": "目标主机", "en-US": "Target host" },
  "sshTrust.fingerprint": { "zh-CN": "当前指纹", "en-US": "Fingerprint" },
  "sshTrust.presented": { "zh-CN": "本次指纹", "en-US": "Presented fingerprint" },
  "sshTrust.trusted": { "zh-CN": "已信任指纹", "en-US": "Trusted fingerprint" },
  "sshTrust.copy": { "zh-CN": "复制", "en-US": "Copy" },
  "sshTrust.copy.success": { "zh-CN": "指纹已复制", "en-US": "Fingerprint copied" },
  "sshTrust.copy.fail": { "zh-CN": "复制指纹失败", "en-US": "Failed to copy fingerprint" },
  "sshTrust.firstUse.title": { "zh-CN": "信任此 SSH 主机？", "en-US": "Trust this SSH host?" },
  "sshTrust.firstUse.banner": { "zh-CN": "首次信任需要人工核对", "en-US": "Manual verification required on first trust" },
  "sshTrust.firstUse.desc": {
    "zh-CN": "这是首次连接到 {host}:{port}，请确认下面的主机密钥指纹是否正确。",
    "en-US": "This is the first connection to {host}:{port}. Verify the host key fingerprint below before trusting it.",
  },
  "sshTrust.firstUse.hint": {
    "zh-CN": "只有在你已通过其他可信渠道核对过指纹时，才应继续信任。",
    "en-US": "Continue only if you have verified this fingerprint through a separate trusted channel.",
  },
  "sshTrust.firstUse.confirm": { "zh-CN": "信任并继续", "en-US": "Trust and continue" },
  "sshTrust.changed.title": { "zh-CN": "SSH 主机指纹已变化", "en-US": "SSH host fingerprint changed" },
  "sshTrust.changed.banner": { "zh-CN": "已信任主机返回了新指纹", "en-US": "A trusted host presented a new fingerprint" },
  "sshTrust.changed.desc": {
    "zh-CN": "{host}:{port} 返回了与上次不同的主机密钥指纹，请在继续前确认这是预期变更。",
    "en-US": "The host key fingerprint for {host}:{port} no longer matches the previously trusted value. Verify the change before continuing.",
  },
  "sshTrust.changed.hint": {
    "zh-CN": "只有在你已确认主机进行了合法密钥轮换时，才应替换已信任指纹。",
    "en-US": "Replace the trusted fingerprint only if you have confirmed a legitimate key rotation.",
  },
  "sshTrust.changed.confirm": { "zh-CN": "替换并继续", "en-US": "Replace and continue" },
  ...
  "messages.empty": { "zh-CN": "暂无消息。连接、同步和传输事件会显示在这里。", "en-US": "No messages yet. Connection, sync, and transfer events will appear here." },
  ...
  "settings.theme.chal": { "zh-CN": "Chal", "en-US": "Chal" },
  "settings.theme.github": { "zh-CN": "GitHub", "en-US": "GitHub" },
  "settings.theme.notinish": { "zh-CN": "Notinish", "en-US": "Notinish" },
  ...
  "settings.terminal.backgroundFit": { "zh-CN": "背景填充", "en-US": "Background fit" },
  "settings.terminal.backgroundFit.cover": { "zh-CN": "填充裁剪", "en-US": "Cover (crop)" },
  "settings.terminal.backgroundFit.contain": { "zh-CN": "完整显示", "en-US": "Contain (fit)" },
  "settings.terminal.backgroundFit.stretch": { "zh-CN": "拉伸铺满", "en-US": "Stretch" },
  ...
  "settings.ai.enabled.desc": { "zh-CN": "开启后可在终端内分析输出、解释错误并生成下一步命令", "en-US": "Analyze terminal output, explain errors, and draft next commands." },
  ...
  "settings.ai.apiKey.desc": { "zh-CN": "仅保存在本机，用于调用所选 AI 服务", "en-US": "Stored locally and used only to call the selected AI service." },
  "settings.ai.openai.desc": { "zh-CN": "填写 OpenAI 或兼容服务的基础地址", "en-US": "Base URL for OpenAI or an OpenAI-compatible service." },
  "settings.ai.anthropic.desc": { "zh-CN": "填写 Anthropic API 基础地址", "en-US": "Base URL for the Anthropic API." },
  "settings.ai.volcengine.desc": {
  ...
  "settings.ai.model.search.empty": { "zh-CN": "没有匹配的模型。可粘贴完整模型 ID 手动添加。", "en-US": "No matching models. Paste a full model ID to add one manually." },
  "settings.ai.model.selected.empty": { "zh-CN": "尚未启用模型。至少选择一个模型后才能使用 AI。", "en-US": "No models enabled. Select at least one model to use AI." },
  ...
  "settings.ai.model.selected.hint": { "zh-CN": "点击已选模型可移除", "en-US": "Click a selected model to remove it." },
  "settings.ai.model.available.hint": { "zh-CN": "点击模型启用；再次点击取消启用", "en-US": "Click a model to enable it; click again to disable it." },
  ...
  "settings.ai.model.refresh.empty": { "zh-CN": "服务未返回模型。请检查 API 地址和密钥，或手动添加模型 ID。", "en-US": "The service returned no models. Check the API URL and key, or add a model ID manually." },
  "settings.ai.model.refresh.fail": { "zh-CN": "无法获取模型列表。请检查网络、API 地址和密钥。", "en-US": "Could not load models. Check the network, API URL, and key." },
  "settings.ai.model.refresh.volcengineHint": {
    "zh-CN": "火山方舟模型列表请求失败。已改为桌面端直连请求；若仍失败，请在火山控制台复制模型 ID 或 Endpoint ID 手动添加。",
    "en-US": "Volcengine model listing failed. The app now uses desktop-side HTTP; if it still fails, copy the Model ID or Endpoint ID from the Volcengine console and add it manually.",
  },
  "settings.ai.model.chatOnly": {
    "zh-CN": "这里只能启用对话模型。Embedding 或 rerank 模型不能用于终端助手。",
    "en-US": "Only chat models work here. Embedding or rerank models cannot power the terminal assistant.",
  },
  "settings.ai.test": { "zh-CN": "连通性测试", "en-US": "Connectivity test" },
  "settings.ai.test.desc": { "zh-CN": "发送一次轻量请求，确认当前提供商、密钥和模型可用", "en-US": "Send a lightweight request to verify the provider, key, and model." },
  ...
  "settings.ai.error.disabled": { "zh-CN": "请先开启 AI，再测试连接", "en-US": "Enable AI before testing the connection." },
  "settings.ai.error.model": { "zh-CN": "请先选择或添加一个对话模型", "en-US": "Select or add a chat model first." },
  ...
  "settings.ai.error.volcengineUrl": {
    "zh-CN": "请填写火山方舟 API 地址",
    "en-US": "Please enter Volcengine Ark API URL",
  },
  ...
  "settings.sync.title": { "zh-CN": "云同步", "en-US": "Cloud Sync" },
  "settings.sync.desc": {
    "zh-CN": "同步服务器配置、密钥配置、脚本和转发规则（端到端加密）。",
    "en-US": "Sync server configs, key profiles, scripts, and forwarding rules (end-to-end encrypted).",
  },
  "settings.sync.configure": { "zh-CN": "配置", "en-US": "Configure" },
  "settings.sync.lastSyncedAt": { "zh-CN": "上次同步：{time}", "en-US": "Last sync: {time}" },
  "settings.sync.modal.title": { "zh-CN": "云同步配置", "en-US": "Cloud Sync Configuration" },
  "settings.sync.provider": { "zh-CN": "提供商", "en-US": "Provider" },
  "settings.sync.webdav.endpoint": { "zh-CN": "WebDAV 地址", "en-US": "WebDAV endpoint" },
  "settings.sync.webdav.endpoint.placeholder": { "zh-CN": "https://...", "en-US": "https://..." },
  "settings.sync.webdav.path": { "zh-CN": "远端路径", "en-US": "Remote path" },
  "settings.sync.webdav.path.placeholder": { "zh-CN": "/noterm-sync", "en-US": "/noterm-sync" },
  "settings.sync.username": { "zh-CN": "用户名", "en-US": "Username" },
  "settings.sync.password": { "zh-CN": "密码", "en-US": "Password" },
  "settings.sync.s3.endpoint": { "zh-CN": "S3 地址", "en-US": "S3 endpoint" },
  "settings.sync.s3.region": { "zh-CN": "Region", "en-US": "Region" },
  "settings.sync.s3.bucket": { "zh-CN": "Bucket", "en-US": "Bucket" },
  "settings.sync.s3.prefix": { "zh-CN": "Prefix", "en-US": "Prefix" },
  "settings.sync.s3.accessKeyId": { "zh-CN": "Access Key ID", "en-US": "Access Key ID" },
  "settings.sync.s3.secretAccessKey": { "zh-CN": "Secret Access Key", "en-US": "Secret Access Key" },
  "settings.sync.s3.pathStyle": { "zh-CN": "使用 Path-Style", "en-US": "Use path-style" },
  ...
  "settings.sync.autoBackupInterval": { "zh-CN": "自动备份间隔", "en-US": "Backup interval" },
  "settings.sync.autoBackup.everyMinutes": {
    "zh-CN": "每 {count} 分钟",
    "en-US": "Every {count} minutes",
  },
  "settings.sync.autoBackup.running": {
    "zh-CN": "正在执行自动备份...",
    "en-US": "Running automatic backup...",
  },
  "settings.sync.autoBackup.done": {
    "zh-CN": "自动备份完成。",
    "en-US": "Automatic backup completed.",
  },
  "settings.sync.autoBackup.failed": {
    "zh-CN": "自动备份失败。",
    "en-US": "Automatic backup failed.",
  },
  ...
  "settings.sync.status.testPassed": { "zh-CN": "连接测试通过。", "en-US": "Connection test passed." },
  "settings.sync.status.testFailed": { "zh-CN": "连接测试失败。", "en-US": "Connection test failed." },
  "settings.sync.status.uploading": { "zh-CN": "正在上传加密同步数据...", "en-US": "Uploading encrypted sync data..." },
  "settings.sync.status.uploadDone": { "zh-CN": "上传完成。", "en-US": "Upload completed." },
  ...
  "ai.error.volcengineUrl": {
    "zh-CN": "未配置火山方舟 API 地址",
    "en-US": "Volcengine Ark API URL not set",
  },
  "ai.error.volcengineKey": {
    "zh-CN": "未配置火山方舟 API 密钥",
    "en-US": "Volcengine Ark API key not set",
  },
  "ai.error.volcengineRequestFail": {
    "zh-CN": "火山方舟请求失败",
    "en-US": "Volcengine Ark request failed",
  },
  ...
  "connections.defaultName.telnet": { "zh-CN": "新 Telnet 连接", "en-US": "New Telnet connection" },
  ...
  "connections.protocol.telnet": { "zh-CN": "终端连接（Telnet）", "en-US": "Terminal (Telnet)" },
  "connections.field.port": { "zh-CN": "连接端口", "en-US": "Port" },
  "connections.section.auth": { "zh-CN": "认证配置", "en-US": "Authentication" },
  "connections.telnet.authHint": {
    "zh-CN": "Telnet 仅提供终端能力，不支持 SSH 私钥、SFTP 或远程命令探测。",
    "en-US": "Telnet is shell-only and does not support SSH keys, SFTP, or remote command probing.",
  },
  ...
  "connections.field.tagEmpty": { "zh-CN": "无标签", "en-US": "No tag" },
  ...
  "connections.onboard.title": { "zh-CN": "连接你的服务器", "en-US": "Connect to your servers" },
  "connections.onboard.subtitle": { "zh-CN": "添加第一个 SSH 或 Telnet 连接，即刻开始", "en-US": "Add your first SSH or Telnet connection to get started" },
  "connections.onboard.cta": { "zh-CN": "添加连接", "en-US": "Add connection" },
  "connections.welcome.title": { "zh-CN": "你的终端，全新体验", "en-US": "Your terminal, reimagined" },
  "connections.welcome.subtitle": { "zh-CN": "从左侧选择一个服务器并连接，开始一个会话", "en-US": "Select a server from the left panel and connect to start a session" },
  "connections.welcome.feature.tabs": { "zh-CN": "多标签会话", "en-US": "Multi-tab sessions" },
  "connections.welcome.feature.tabsDesc": { "zh-CN": "并排运行多个会话，支持分屏显示", "en-US": "Run multiple sessions side by side with split-screen support" },
  "connections.welcome.feature.sftp": { "zh-CN": "SFTP 文件管理", "en-US": "SFTP file manager" },
  "connections.welcome.feature.sftpDesc": { "zh-CN": "浏览、上传和下载任意服务器上的文件", "en-US": "Browse, upload, and download files from any connected server" },
  "connections.welcome.feature.ai": { "zh-CN": "AI 助手", "en-US": "AI assistant" },
  "connections.welcome.feature.aiDesc": { "zh-CN": "提问、获取命令建议，智能分析输出内容", "en-US": "Ask questions, get command suggestions, and analyze output" },
  "connections.welcome.feature.scripts": { "zh-CN": "脚本片段", "en-US": "Script snippets" },
  "connections.welcome.feature.scriptsDesc": { "zh-CN": "保存常用命令，一键执行", "en-US": "Save and run frequently-used commands with one click" },
  ...
  "forwarding.action.starting": { "zh-CN": "启动中…", "en-US": "Starting…" },
  "forwarding.action.stop": { "zh-CN": "停止", "en-US": "Stop" },
  "forwarding.action.stopping": { "zh-CN": "停止中…", "en-US": "Stopping…" },
  ...
  "terminal.sftp.edit.download.progress": {
    "zh-CN": "准备本地编辑: {name}",
    "en-US": "Preparing local edit: {name}",
  },
  "terminal.sftp.edit.opened": {
    "zh-CN": "已打开本地编辑联动",
    "en-US": "Opened with local edit sync",
  },
  "terminal.sftp.edit.opened.title": {
    "zh-CN": "已打开系统编辑器",
    "en-US": "Opened in system editor",
  },
  "terminal.sftp.edit.opened.detail": {
    "zh-CN": "文件“{name}”保存后会自动同步到服务器",
    "en-US": "Changes to “{name}” will sync back to the server automatically",
  },
  "terminal.sftp.edit.open.fail": {
    "zh-CN": "打开联动编辑失败: {message}",
    "en-US": "Failed to open linked editing: {message}",
  },
  "terminal.sftp.edit.sync.progress": {
    "zh-CN": "同步修改中: {name}",
    "en-US": "Syncing changes: {name}",
  },
  "terminal.sftp.edit.sync.done": {
    "zh-CN": "自动同步完成",
    "en-US": "Auto sync completed",
  },
  "terminal.sftp.edit.sync.notice.generic": {
    "zh-CN": "“{name}”未能同步回服务器",
    "en-US": "Failed to sync “{name}” back to the server",
  },
  "terminal.sftp.edit.sync.notice.permission": {
    "zh-CN": "“{name}”无法写回服务器，当前账号没有写入权限",
    "en-US": "Cannot write “{name}” back to the server because this account has no write permission",
  },
  "terminal.sftp.edit.sync.fail": {
    "zh-CN": "自动同步失败 {name}: {message}",
    "en-US": "Auto sync failed for {name}: {message}",
  },
  "terminal.sftp.edit.sync.toast.title": {
    "zh-CN": "自动同步失败",
    "en-US": "Auto sync failed",
  },
  "terminal.sftp.edit.sync.toast.permission.detail": {
    "zh-CN": "当前 SSH/SFTP 账号对该文件没有写入权限：{path}",
    "en-US": "The current SSH/SFTP account does not have write permission for {path}",
  },
  "terminal.sftp.notice.close": {
    "zh-CN": "关闭提示",
    "en-US": "Dismiss notice",
  },
  ...
  "terminal.sftp.menu.open": { "zh-CN": "打开并联动编辑", "en-US": "Open with sync" },
  ...
  "terminal.ai.context.summary.structured": {
    ...
    "en-US": "Structured terminal context is ready for follow-up questions",
  },
  "terminal.ai.context.summary.logs": {
    "zh-CN": "最近的日志信号已提炼，便于快速排障",
    "en-US": "Recent log signals are summarized for quick troubleshooting",
  },
  "terminal.ai.context.summary.both": {
    "zh-CN": "已整理终端输出与最近日志信号",
    "en-US": "Structured terminal output and recent log signals are ready",
  },
  "terminal.ai.onboard.badge": { "zh-CN": "友好助手", "en-US": "Friendly assistant" },
  "terminal.ai.onboard.title": {
    "zh-CN": "遇到问题时，先让 AI 帮你看一眼",
    "en-US": "Let AI look first when something feels off",
  },
  "terminal.ai.onboard.hint": {
    "zh-CN": "先运行一个命令或选中终端输出，AI 的分析会更可靠。",
    "en-US": "Run a command or select terminal output first so the assistant can stay grounded in the current session.",
  },
  "terminal.ai.onboard.hint.ready": {
    "zh-CN": "当前终端上下文已准备好，直接让 AI 分析或排查即可。",
    "en-US": "Current terminal context is ready. Ask AI to analyze it or troubleshoot from it directly.",
  },
  "terminal.ai.onboard.contextNeeded": {
    "zh-CN": "先运行一个命令或选中一段终端输出，再让 AI 分析。",
    "en-US": "Run a command or select some terminal output first, then ask AI to analyze it.",
  },
  "terminal.ai.onboard.askSeed": {
    "zh-CN": "帮我看看这台服务器现在最值得关注的状态和风险。",
    "en-US": "Help me understand the most important current state and risks on this server.",
  },
  "terminal.ai.onboard.action.analyze.title": {
    "zh-CN": "分析当前输出",
    "en-US": "Analyze current output",
  },
  "terminal.ai.onboard.action.analyze.desc": {
    "zh-CN": "总结刚才终端里发生了什么，以及你下一步该关注什么。",
    "en-US": "Summarize what the terminal is telling you and what to pay attention to next.",
  },
  "terminal.ai.onboard.action.fix.title": {
    "zh-CN": "排查最近问题",
    "en-US": "Diagnose the latest issue",
  },
  "terminal.ai.onboard.action.fix.desc": {
    "zh-CN": "结合当前上下文定位问题，并给出下一步可执行命令。",
    "en-US": "Use the current terminal context to identify the issue and propose executable next-step commands.",
  },
  "terminal.ai.onboard.action.ask.title": {
    "zh-CN": "开始提问",
    "en-US": "Start with a question",
  },
  "terminal.ai.onboard.action.ask.desc": {
    "zh-CN": "先填入一个示例问题，你可以继续改成自己的表达。",
    "en-US": "Start from a sample question and rewrite it into your own request.",
  },
  "terminal.ai.onboard.shortcuts": {
    "zh-CN": "也可以直接在终端输入：",
    "en-US": "You can also trigger it from the terminal:",
  },
  ...
  "terminal.agent.planning": { "zh-CN": "计划中...", "en-US": "Planning..." },
  ...
  "terminal.agent.activity.expand": {
    "zh-CN": "展开全部过程",
    "en-US": "Show full activity",
  },
  "terminal.agent.activity.collapse": { "zh-CN": "收起执行过程", "en-US": "Collapse activity" },
  ...
  "terminal.transfer.status.paused": { "zh-CN": "已暂停", "en-US": "Paused" },
  ...
  "terminal.transfer.createdAt": { "zh-CN": "创建于 {time}", "en-US": "Created at {time}" },
  "terminal.transfer.pause": { "zh-CN": "暂停", "en-US": "Pause" },
  "terminal.transfer.resume": { "zh-CN": "继续", "en-US": "Resume" },
  "terminal.transfer.delete": { "zh-CN": "删除任务", "en-US": "Delete task" },
  "terminal.transfer.resuming": { "zh-CN": "正在继续下载…", "en-US": "Resuming download..." },
  "terminal.transfer.paused.detail": { "zh-CN": "已暂停，可从当前进度继续", "en-US": "Paused. Resume keeps the current progress." },
  "terminal.transfer.interrupted.detail": {
    "zh-CN": "任务因上次关闭应用而中断",
    "en-US": "Interrupted when the app was last closed",
  },
  "terminal.transfer.openFolder": { "zh-CN": "打开目录", "en-US": "Open folder" },
  "terminal.transfer.openFolder.fail": { "zh-CN": "打开目录失败：{message}", "en-US": "Failed to open folder: {message}" },
